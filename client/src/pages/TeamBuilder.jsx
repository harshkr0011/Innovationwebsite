...
const TeamBuilder = () => {
    ...
    const fetchMatches = async () => {
        ...
        try {
            ...
            const res = await fetch(`http://localhost:5000/api/team/match?${queryParams.toString()}`, {
        ...
        <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
            <div className="glass-panel" style={{ padding: '3rem', marginBottom: '2rem', textAlign: 'center' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
                    {['All', 'Student', 'Developer', 'Designer', 'Mentor'].map(role => (
                        <button
                            key={role}
                            ...
                            style={{
                                ...
                                background: selectedRole === role ? 'var(--primary)' : 'rgba(255,255,255,0.05)',
                ...
                <div style={{
                    ...
                    <div className="glass-panel" style={{ width: '90%', maxWidth: '500px', padding: '2rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1.5rem', alignItems: 'center' }}>
                            ...
                            <button onClick={() => { setChatModal(null); setChatMessage(''); }} style={{ background: 'none', border: 'none', color: 'var(--text-main)', cursor: 'pointer' }}>
                                <X size={24} />
                            </button>
                        </div>
