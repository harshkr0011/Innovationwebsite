...
import { Rocket, Menu, X, User, LogOut, LayoutDashboard, Sparkles, Users, UserCheck, Map, Settings, ChevronDown, FileText, DollarSign, Layout, Briefcase, Wrench, Compass, Sun, Moon } from 'lucide-react';
...
const Navbar = () => {
    ...
    const mainNavLinks = [
        ...
        { path: '/launchpad', label: 'Launchpad', icon: Rocket, public: true },
        ...
        return (
            <Link
                ...
                style={{
                    ...
                    fontSize: '0.9rem',
                    background: active ? 'var(--active-item-bg)' : 'transparent',
                    transition: 'all 0.2s',
            ...
            <div className={containerClass} style={{ position: 'relative' }}>
                <button
                    ...
                    style={{
                        ...
                        fontSize: '0.9rem',
                        background: hasActive || isOpen ? 'var(--active-item-bg)' : 'transparent',
                        transition: 'all 0.2s',
                    ...
                    <div className="user-menu-container" style={{ position: 'relative' }}>
                        <button
                            ...
                            style={{
                                ...
                                borderRadius: '9999px',
                                border: '1px solid var(--glass-border)',
                                background: userMenuOpen ? 'var(--active-item-bg)' : 'transparent',
                                color: 'var(--text-main)',
                                cursor: 'pointer',
                                fontWeight: '500',
                                fontSize: '0.9rem',
